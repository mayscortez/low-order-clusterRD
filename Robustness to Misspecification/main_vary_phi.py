...
def main(model, graphNum, T, B=0.06, p=1, p_in = 0.5, p_out = 0, cluster_selection = "bernoulli"):
    '''
    model (dict) 
    ...
    p (float): treatment probability within clusters (i.e. conditioned on being in a chosen cluster)
